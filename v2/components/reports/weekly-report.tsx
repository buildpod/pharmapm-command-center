...
export function WeeklyReport() {
  ...
  const data = useMemo(
    () => buildWeeklyReportData({ project: activeProject, milestones, tasks, risks, documents, costLines, decisionRecords, issues, evm, auditLog: readAuditLog(activeProject.id) }),
