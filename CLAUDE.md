...
Read `AIVELLO_OPERATING_DOC.md` first, then identify the current module from section 4 before writing code.
...
For critical delivery-truth engines, formalize the behavior and tests before polishing UI. Keep one module per session and log decisions in the operating doc.
